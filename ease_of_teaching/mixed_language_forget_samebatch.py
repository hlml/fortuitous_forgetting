...
parser.add_argument('--trainIters', type=int, default=700, help='number of training iterations')
...
parser.add_argument('--train_with_reset', action='store_true') 
...
if not args_raw.no_wandb:
    if len(args_raw.group_vars) > 0:
        ...
        wandb.init(project="ease_of_teaching_target",
...
#             print(record)
    ...
    if i % args_raw.reset_every == 0:
        if args_raw.train_with_reset:
            testsender.load_state_dict(teamCLONE.state_dict())
