...
if __name__ == "__main__":
    split_frac = 0.85
    train_data = datasets.CIFAR10(root='./cifar10_raw', train=True, download=True)
    test_data = datasets.CIFAR10(root='./cifar10_raw', train=False, download=True) 
    ...
    dump_data('./CIFAR10', train_data, train_members, test_data, test_members)
    dump_data('./CIFAR10val', train_data, subtrain_members, train_data, subval_members)